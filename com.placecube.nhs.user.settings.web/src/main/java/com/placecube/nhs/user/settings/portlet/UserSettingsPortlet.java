...
@Component(immediate = true, property = { "com.liferay.fragment.entry.processor.portlet.alias=user-privacy", "com.liferay.portlet.css-class-wrapper=portlet-user-profile portlet-user-privacy",
		...
		"javax.portlet.security-role-ref=power-user,user", "javax.portlet.name=" + PortletKeys.USER_SETTINGS,
