...
@Component(immediate = true, property = { "com.liferay.fragment.entry.processor.portlet.alias=user-privacy", "com.liferay.portlet.css-class-wrapper=portlet-nhs-maximized portlet-user-settings",
