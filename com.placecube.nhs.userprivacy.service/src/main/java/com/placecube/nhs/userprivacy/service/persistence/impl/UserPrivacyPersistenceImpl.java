...
public class UserPrivacyPersistenceImpl
	...
	public UserPrivacy[] findByUuid_PrevAndNext(
		...
		UserPrivacy userPrivacy = findByPrimaryKey(userPrivacyId);
	...
	public UserPrivacy create(long userPrivacyId) {
		...
		userPrivacy.setPrimaryKey(userPrivacyId);
	...
	public UserPrivacy remove(long userPrivacyId)
		...
		return remove((Serializable)userPrivacyId);
	}
	...
	public UserPrivacy findByPrimaryKey(long userPrivacyId)
		...
		return findByPrimaryKey((Serializable)userPrivacyId);
	}
	...
	public UserPrivacy fetchByPrimaryKey(long userPrivacyId) {
		return fetchByPrimaryKey((Serializable)userPrivacyId);
	}
