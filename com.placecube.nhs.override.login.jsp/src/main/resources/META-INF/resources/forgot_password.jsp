...
<liferay-util:buffer var="html">
    <liferay-util:include page="/forgot_password.portal.jsp" servletContext="<%= application %>" />
</liferay-util:buffer>
...
//Change all window states to normal
html = StringUtil.replace(html, "maximized" , "normal");
%>
