...
package com.placecube.nhs.talentsearch.service.base;
...
/**
 * Provides the base implementation for the talent search local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.placecube.nhs.talentsearch.service.impl.TalentSearchLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.placecube.nhs.talentsearch.service.impl.TalentSearchLocalServiceImpl
 * @generated
 */
@ProviderType
public abstract class TalentSearchLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements TalentSearchLocalService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TalentSearchLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.placecube.nhs.talentsearch.service.TalentSearchLocalServiceUtil</code>.
	 */
	...
	public TalentSearch addTalentSearch(TalentSearch talentSearch) {
		...
		return talentSearchPersistence.update(talentSearch);
	}
	...
	public TalentSearch createTalentSearch(long talentSearchId) {
		return talentSearchPersistence.create(talentSearchId);
	}
	...
	public TalentSearch deleteTalentSearch(long talentSearchId)
		...
		return talentSearchPersistence.remove(talentSearchId);
	}
	...
	public TalentSearch deleteTalentSearch(TalentSearch talentSearch) {
		return talentSearchPersistence.remove(talentSearch);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TalentSearch.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return talentSearchPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return talentSearchPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return talentSearchPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return talentSearchPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public TalentSearch fetchTalentSearch(long talentSearchId) {
		return talentSearchPersistence.fetchByPrimaryKey(talentSearchId);
	}
	...
	public TalentSearch fetchTalentSearchByUuidAndCompanyId(
		...
		return talentSearchPersistence.fetchByUuid_C_First(
			uuid, companyId, null);
	}
	...
	public TalentSearch getTalentSearch(long talentSearchId)
		...
		return talentSearchPersistence.findByPrimaryKey(talentSearchId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(talentSearchLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TalentSearch.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("talentSearchId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			talentSearchLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(TalentSearch.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<TalentSearch>() {

				@Override
				public void performAction(TalentSearch talentSearch)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, talentSearch);
				}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return talentSearchLocalService.deleteTalentSearch(
			(TalentSearch)persistedModel);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return talentSearchPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public TalentSearch getTalentSearchByUuidAndCompanyId(
		...
		return talentSearchPersistence.findByUuid_C_First(
			uuid, companyId, null);
	}
	...
	public List<TalentSearch> getTalentSearchs(int start, int end) {
		return talentSearchPersistence.findAll(start, end);
	}
	...
	public int getTalentSearchsCount() {
		return talentSearchPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TalentSearchLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		talentSearchLocalService = (TalentSearchLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TalentSearchLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = talentSearchPersistence.getDataSource();
	...
	protected TalentSearchLocalService talentSearchLocalService;

	@Reference
	protected TalentSearchPersistence talentSearchPersistence;
