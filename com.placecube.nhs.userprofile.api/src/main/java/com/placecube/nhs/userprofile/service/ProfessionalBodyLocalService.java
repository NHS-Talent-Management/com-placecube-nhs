...
/**
 * Provides the local service interface for ProfessionalBody. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ProfessionalBodyLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ProfessionalBodyLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ProfessionalBodyLocalServiceUtil} to access the professional body local service. Add custom service methods to <code>com.placecube.nhs.userprofile.service.impl.ProfessionalBodyLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
