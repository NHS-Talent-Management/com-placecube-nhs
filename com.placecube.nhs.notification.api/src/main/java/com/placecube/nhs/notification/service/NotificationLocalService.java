...
public interface NotificationLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link NotificationLocalServiceUtil} to access the notification local service. Add custom service methods to <code>com.placecube.nhs.notification.service.impl.NotificationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public Notification createNotification(
			User user, NotificationType notificationType, String summary,
			String body, List<Long> receiverUserIds)
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Notification fetchNotificationByUuidAndCompanyId(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Notification getNotificationByUuidAndCompanyId(
			String uuid, long companyId)
		throws PortalException;
