...
@Component(immediate = true, property = { "expandocolumn.creator=user.readiness" }, service = ExpandoColumnCreator.class)
public class ReadinessColumnCreator implements ExpandoColumnCreator {
	...
	public ExpandoColumn create(Company company) throws ExpandoColumnCreationException {
		InputStream inputStream = ReadinessColumnCreator.class.getClassLoader()
				.getResourceAsStream("com/placecube/nhs/user/expando/dependencies/expando/" + UserExpando.READINESS.getFieldName() + ".xml");
