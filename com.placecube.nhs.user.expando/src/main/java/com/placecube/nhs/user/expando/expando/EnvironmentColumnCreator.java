...
@Component(immediate = true, property = { "expandocolumn.creator=user.environment" }, service = ExpandoColumnCreator.class)
public class EnvironmentColumnCreator implements ExpandoColumnCreator {
	...
	public ExpandoColumn create(Company company) throws ExpandoColumnCreationException {
		InputStream inputStream = EnvironmentColumnCreator.class.getClassLoader()
				.getResourceAsStream("com/placecube/nhs/user/expando/dependencies/expando/" + UserExpando.ENVIRONMENT.getFieldName() + ".xml");
