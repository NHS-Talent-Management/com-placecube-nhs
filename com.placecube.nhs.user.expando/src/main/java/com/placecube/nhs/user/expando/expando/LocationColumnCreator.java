...
@Component(immediate = true, property = { "expandocolumn.creator=user.location" }, service = ExpandoColumnCreator.class)
public class LocationColumnCreator implements ExpandoColumnCreator {
	...
	public ExpandoColumn create(Company company) throws ExpandoColumnCreationException {
		InputStream inputStream = LocationColumnCreator.class.getClassLoader()
				.getResourceAsStream("com/placecube/nhs/user/expando/dependencies/expando/" + UserExpando.LOCATION.getFieldName() + ".xml");
