...
import com.placecube.nhs.userprofile.model.impl.QualificationImpl;
import com.placecube.nhs.userprofile.model.impl.QualificationModelImpl;
...
public class QualificationPersistenceImpl
	 ...
	 */
	@Override
	public List<Qualification> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<Qualification> findByUuid(String uuid, int start, int end) {
	 ...
	 */
	@Override
	public List<Qualification> findByUuid(
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Qualification qualification : list) {
					if (!uuid.equals(qualification.getUuid())) {
						list = null;
	...
	public Qualification findByUuid_First(
		...
		Qualification qualification = fetchByUuid_First(
	...
	public Qualification fetchByUuid_First(
		...
		List<Qualification> list = findByUuid(uuid, 0, 1, orderByComparator);
	...
	public Qualification findByUuid_Last(
		...
		Qualification qualification = fetchByUuid_Last(uuid, orderByComparator);
	...
	public Qualification fetchByUuid_Last(
		...
		List<Qualification> list = findByUuid(
	...
	public Qualification[] findByUuid_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_PrevAndNext(
				session, qualification, uuid, orderByComparator, true);

			array[1] = qualification;

			array[2] = getByUuid_PrevAndNext(
				session, qualification, uuid, orderByComparator, false);
	...
	protected Qualification getByUuid_PrevAndNext(
		Session session, Qualification qualification, String uuid,
		OrderByComparator<Qualification> orderByComparator, boolean previous) {
	...
	private static final String _FINDER_COLUMN_UUID_UUID_3 =
		"(qualification.uuid IS NULL OR qualification.uuid = '')";
	 ...
	 */
	@Override
	public List<Qualification> findByUuid_C(String uuid, long companyId) {
		return findByUuid_C(
	 ...
	 */
	@Override
	public List<Qualification> findByUuid_C(
	...
	public List<Qualification> findByUuid_C(
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Qualification qualification : list) {
					if (!uuid.equals(qualification.getUuid()) ||
						(companyId != qualification.getCompanyId())) {
	...
	public Qualification findByUuid_C_First(
		...
		Qualification qualification = fetchByUuid_C_First(
	...
	public Qualification fetchByUuid_C_First(
		...
		List<Qualification> list = findByUuid_C(
	...
	public Qualification findByUuid_C_Last(
		...
		Qualification qualification = fetchByUuid_C_Last(
			uuid, companyId, orderByComparator);
	...
	public Qualification[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, qualification, uuid, companyId, orderByComparator,
				true);
	...
	protected Qualification getByUuid_C_PrevAndNext(
		Session session, Qualification qualification, String uuid,
		long companyId, OrderByComparator<Qualification> orderByComparator,
		boolean previous) {
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_2 =
		"qualification.uuid = ? AND ";

	private static final String _FINDER_COLUMN_UUID_C_UUID_3 =
		"(qualification.uuid IS NULL OR qualification.uuid = '') AND ";

	private static final String _FINDER_COLUMN_UUID_C_COMPANYID_2 =
		"qualification.companyId = ?";
	 ...
	 */
	@Override
	public List<Qualification> findByUserId(long userId, int start, int end) {
	 ...
	 */
	@Override
	public List<Qualification> findByUserId(
	...
	public List<Qualification> findByUserId(
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Qualification qualification : list) {
					if ((userId != qualification.getUserId())) {
						list = null;
	...
	public Qualification findByUserId_First(
		...
		Qualification qualification = fetchByUserId_First(
	...
	public Qualification fetchByUserId_First(
		...
		List<Qualification> list = findByUserId(
	...
	public Qualification findByUserId_Last(
		...
		Qualification qualification = fetchByUserId_Last(
			userId, orderByComparator);
	...
	public Qualification[] findByUserId_PrevAndNext(
		...
		try {
			...
			array[0] = getByUserId_PrevAndNext(
				session, qualification, userId, orderByComparator, true);

			array[1] = qualification;

			array[2] = getByUserId_PrevAndNext(
				session, qualification, userId, orderByComparator, false);
	...
	protected Qualification getByUserId_PrevAndNext(
		Session session, Qualification qualification, long userId,
		OrderByComparator<Qualification> orderByComparator, boolean previous) {
	...
	public void cacheResult(Qualification qualification) {
		entityCache.putResult(
			entityCacheEnabled, QualificationImpl.class,
			qualification.getPrimaryKey(), qualification);
	...
	public void cacheResult(List<Qualification> qualifications) {
		for (Qualification qualification : qualifications) {
			if (entityCache.getResult(
					entityCacheEnabled, QualificationImpl.class,
					qualification.getPrimaryKey()) == null) {
	...
	public Qualification create(long qualificationId) {
		...
		qualification.setCompanyId(companyProvider.getCompanyId());
	...
	public Qualification updateImpl(Qualification qualification) {
		...
		if (Validator.isNull(qualification.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (!_columnBitmaskEnabled) {
			...
			Object[] args = new Object[] {qualificationModelImpl.getUuid()};
			...
			args = new Object[] {
				qualificationModelImpl.getUuid(),
				qualificationModelImpl.getCompanyId()
			};
			...
			args = new Object[] {qualificationModelImpl.getUserId()};
			...
			if ((qualificationModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					qualificationModelImpl.getOriginalUuid()
				};
				...
				args = new Object[] {qualificationModelImpl.getUuid()};
			...
			if ((qualificationModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					qualificationModelImpl.getOriginalUuid(),
					qualificationModelImpl.getOriginalCompanyId()
				};
			...
			if ((qualificationModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					qualificationModelImpl.getOriginalUserId()
				};
		...
		entityCache.putResult(
			entityCacheEnabled, QualificationImpl.class,
			qualification.getPrimaryKey(), qualification, false);
	...
	public void activate() {
		QualificationModelImpl.setEntityCacheEnabled(entityCacheEnabled);
		QualificationModelImpl.setFinderCacheEnabled(finderCacheEnabled);

		_finderPathWithPaginationFindAll = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, QualificationImpl.class,
		...
		_finderPathWithoutPaginationFindByUuid = new FinderPath(
			...
			QualificationModelImpl.UUID_COLUMN_BITMASK |
			QualificationModelImpl.FROMDATE_COLUMN_BITMASK);
		...
		_finderPathWithoutPaginationFindByUuid_C = new FinderPath(
			...
			QualificationModelImpl.UUID_COLUMN_BITMASK |
			QualificationModelImpl.COMPANYID_COLUMN_BITMASK |
			QualificationModelImpl.FROMDATE_COLUMN_BITMASK);
		...
		_finderPathWithoutPaginationFindByUserId = new FinderPath(
			...
			QualificationModelImpl.USERID_COLUMN_BITMASK |
			QualificationModelImpl.FROMDATE_COLUMN_BITMASK);
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.placecube.nhs.userprofile.model.Qualification"),
			true);
	}
	...
	private static final String _SQL_SELECT_QUALIFICATION_WHERE =
		"SELECT qualification FROM Qualification qualification WHERE ";

	private static final String _SQL_COUNT_QUALIFICATION =
		"SELECT COUNT(qualification) FROM Qualification qualification";

	private static final String _SQL_COUNT_QUALIFICATION_WHERE =
		"SELECT COUNT(qualification) FROM Qualification qualification WHERE ";
	...
	private static final String _NO_SUCH_ENTITY_WITH_KEY =
		"No Qualification exists with the key {";
