...
import com.placecube.nhs.userprofile.model.impl.ExperienceImpl;
import com.placecube.nhs.userprofile.model.impl.ExperienceModelImpl;
...
public class ExperiencePersistenceImpl
	 ...
	 */
	@Override
	public List<Experience> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<Experience> findByUuid(String uuid, int start, int end) {
	 ...
	 */
	@Override
	public List<Experience> findByUuid(
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Experience experience : list) {
					if (!uuid.equals(experience.getUuid())) {
						list = null;
	...
	public Experience findByUuid_First(
		...
		Experience experience = fetchByUuid_First(uuid, orderByComparator);
	...
	public Experience fetchByUuid_First(
		...
		List<Experience> list = findByUuid(uuid, 0, 1, orderByComparator);
	...
	public Experience findByUuid_Last(
		...
		Experience experience = fetchByUuid_Last(uuid, orderByComparator);
	...
	public Experience fetchByUuid_Last(
		...
		List<Experience> list = findByUuid(
	...
	public Experience[] findByUuid_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_PrevAndNext(
				session, experience, uuid, orderByComparator, true);

			array[1] = experience;

			array[2] = getByUuid_PrevAndNext(
				session, experience, uuid, orderByComparator, false);
	...
	protected Experience getByUuid_PrevAndNext(
		Session session, Experience experience, String uuid,
	...
	private static final String _FINDER_COLUMN_UUID_UUID_3 =
		"(experience.uuid IS NULL OR experience.uuid = '')";
	 ...
	 */
	@Override
	public List<Experience> findByUuid_C(String uuid, long companyId) {
		return findByUuid_C(
	 ...
	 */
	@Override
	public List<Experience> findByUuid_C(
	...
	public List<Experience> findByUuid_C(
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Experience experience : list) {
					if (!uuid.equals(experience.getUuid()) ||
						(companyId != experience.getCompanyId())) {
	...
	public Experience findByUuid_C_First(
		...
		Experience experience = fetchByUuid_C_First(
	...
	public Experience fetchByUuid_C_First(
		...
		List<Experience> list = findByUuid_C(
	...
	public Experience findByUuid_C_Last(
		...
		Experience experience = fetchByUuid_C_Last(
			uuid, companyId, orderByComparator);
	...
	public Experience[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, experience, uuid, companyId, orderByComparator, true);

			array[1] = experience;

			array[2] = getByUuid_C_PrevAndNext(
				session, experience, uuid, companyId, orderByComparator, false);
	...
	protected Experience getByUuid_C_PrevAndNext(
		Session session, Experience experience, String uuid, long companyId,
		OrderByComparator<Experience> orderByComparator, boolean previous) {
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 =
		"(experience.uuid IS NULL OR experience.uuid = '') AND ";
	 ...
	 */
	@Override
	public List<Experience> findByUserId(long userId, int start, int end) {
	 ...
	 */
	@Override
	public List<Experience> findByUserId(
	...
	public List<Experience> findByUserId(
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Experience experience : list) {
					if ((userId != experience.getUserId())) {
						list = null;
	...
	public Experience findByUserId_First(
		...
		Experience experience = fetchByUserId_First(userId, orderByComparator);
	...
	public Experience fetchByUserId_First(
		...
		List<Experience> list = findByUserId(userId, 0, 1, orderByComparator);
	...
	public Experience findByUserId_Last(
		...
		Experience experience = fetchByUserId_Last(userId, orderByComparator);
	...
	public Experience fetchByUserId_Last(
		...
		List<Experience> list = findByUserId(
	...
	public Experience[] findByUserId_PrevAndNext(
		...
		try {
			...
			array[0] = getByUserId_PrevAndNext(
				session, experience, userId, orderByComparator, true);

			array[1] = experience;

			array[2] = getByUserId_PrevAndNext(
				session, experience, userId, orderByComparator, false);
	...
	protected Experience getByUserId_PrevAndNext(
		Session session, Experience experience, long userId,
		OrderByComparator<Experience> orderByComparator, boolean previous) {
	...
	public void cacheResult(Experience experience) {
		entityCache.putResult(
			entityCacheEnabled, ExperienceImpl.class,
			experience.getPrimaryKey(), experience);
	...
	public Experience create(long experienceId) {
		...
		experience.setCompanyId(companyProvider.getCompanyId());
	...
	public Experience updateImpl(Experience experience) {
		...
		if (Validator.isNull(experience.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (!_columnBitmaskEnabled) {
			...
			Object[] args = new Object[] {experienceModelImpl.getUuid()};
			...
			args = new Object[] {
				experienceModelImpl.getUuid(),
				experienceModelImpl.getCompanyId()
			};
			...
			args = new Object[] {experienceModelImpl.getUserId()};
			...
			if ((experienceModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					experienceModelImpl.getOriginalUuid()
				};
				...
				args = new Object[] {experienceModelImpl.getUuid()};
			...
			if ((experienceModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					experienceModelImpl.getOriginalUuid(),
					experienceModelImpl.getOriginalCompanyId()
				};
			...
			if ((experienceModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					experienceModelImpl.getOriginalUserId()
				};
		...
		entityCache.putResult(
			entityCacheEnabled, ExperienceImpl.class,
			experience.getPrimaryKey(), experience, false);
	...
	public void activate() {
		ExperienceModelImpl.setEntityCacheEnabled(entityCacheEnabled);
		ExperienceModelImpl.setFinderCacheEnabled(finderCacheEnabled);

		_finderPathWithPaginationFindAll = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, ExperienceImpl.class,
		...
		_finderPathWithoutPaginationFindByUuid = new FinderPath(
			...
			ExperienceModelImpl.UUID_COLUMN_BITMASK |
			ExperienceModelImpl.FROMDATE_COLUMN_BITMASK);
		...
		_finderPathWithoutPaginationFindByUuid_C = new FinderPath(
			...
			ExperienceModelImpl.UUID_COLUMN_BITMASK |
			ExperienceModelImpl.COMPANYID_COLUMN_BITMASK |
			ExperienceModelImpl.FROMDATE_COLUMN_BITMASK);
		...
		_finderPathWithoutPaginationFindByUserId = new FinderPath(
			...
			ExperienceModelImpl.USERID_COLUMN_BITMASK |
			ExperienceModelImpl.FROMDATE_COLUMN_BITMASK);
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.placecube.nhs.userprofile.model.Experience"),
			true);
	}
